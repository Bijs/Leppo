  ...
  public function fetchSocial($btn, $options)
  {
    ...
    switch ($options['content'][$btn]['item-type']) {
      case 'image':
        switch ($btn) {
          case 'facebook':
            $button = "<a target='_blank' ". $id ." href='https://www.facebook.com/sharer/sharer.php?u=". $options['url'] ."&t=" . $options['title']. "'><img alt='Share- ". $options['title'] ."' src='".$options['content'][$btn]['value']."' class='".$options['class-prefix']. $options['content'][$btn]['class'] ."'" . $size . "></a>";
            break;
          case 'twitter':
            $button = "<a target='_blank' ". $id ." href='https://twitter.com/intent/tweet?text=". $options['title'] ."&source=sharethiscom&related=sharethis&url=" . $options['url'] . "'><img alt='Share- ". $options['title'] ."' src='".$options['content'][$btn]['value']."' class='".$options['class-prefix']. $options['content'][$btn]['class'] ."'" . $size . "></a>";
            break;
          case 'linkedin':
            $button = "<a target='_blank' ". $id ." href='https://www.linkedin.com/shareArticle?summary=&title=" . $options['title'] . "&mini=true&url=" . $options['url'] . "&source='><img alt='Share- ". $options['title'] ."' src='".$options['content'][$btn]['value']."' class='".$options['class-prefix']. $options['content'][$btn]['class'] ."'" . $size . "></a>";
            break;
          case 'googleplus':
            $button = "<a target='_blank' ". $id ." href='https://plus.google.com/share?url=". $options['url'] ."'><img alt='Share- ". $options['title'] ."' src='".$options['content'][$btn]['value']."' class='".$options['class-prefix']. $options['content'][$btn]['class'] ."'" . $size . "></a>";
            break;
          case 'email':
            $button = "<a ". $id ." href='mailto:?subject=" . $options['title'] . "&body=" . $options['url'] . "\n' class='".$options['class-prefix']. $options['content'][$btn]['class'] ."'><img alt='Share- ". $options['title'] ."' src='" . $options['content'][$btn]['value'] ."' " . $size . "></a>";
            break;
          case 'print':
            $button = "<a ". $id ." href='javascript: window.print();'><img alt='Share- ". $options['title'] ."' src='". $options['content'][$btn]['value']."' class='".$options['class-prefix']. $options['content'][$btn]['class'] ."'></a>";
            break;
        }
        break;
